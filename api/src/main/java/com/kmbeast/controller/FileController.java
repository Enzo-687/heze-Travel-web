...
public class FileController {
    ...
    // 如果修改端口，此处注意修改
    private final static String applicationBasePath = "http://localhost:21090";
    ...
    private Map<String, Object> handleFileUpload(MultipartFile multipartFile) {
        ...
        try {
            if (saveUploadedFile(multipartFile, fileName)) {
                ...
                response.put("data", applicationBasePath + apiContextPath + "/file/getFile?" + FILE_NAME_PARAM + "=" + fileName);
                return response;
            }
        } catch (IOException e) {

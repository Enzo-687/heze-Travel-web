        ...
        <div class="table-container">
            <el-table :data="userList" v-loading="loading">
                                    ...
                                    <div>
                                        <el-tooltip class="item" effect="dark"
                                            ...
                                            <img width="40px" height="40px"
                                                style="cursor: pointer;border-radius: 50%;border: 2px dashed #555;"
                ...
                <el-table-column label="功能操作" width="130" align="right">
                    <template #default="scope">
                        <el-button type="primary" round size="small" @click="handleEdit(scope.row)">
                            <el-icon>
                                <Edit />
                            </el-icon>
                            修改
                        </el-button>
                        <el-button type="danger" round size="small" @click="handleDelete(scope.row)">
                            <el-icon>
                                <Delete />
                            </el-icon>
                            注销
                    ...
                    <template #default="scope">
                        <div style="display: flex;justify-content: left;align-items: center;gap: 6px;">
                            <el-switch @change="(value: any) => handleUserStatus(scope.row, 'login', value)"
                                :model-value="scope.row.loginStatus" active-color="#e63f31" inactive-color="#f1f1f1"
                                active-text="封禁" inactive-text="正常">
                            </el-switch>
                            <el-tooltip class="item" effect="dark" content="【封禁状态】用户不可登录；【正常状态】：账户正常使用"
                    ...
                    <template #default="scope">
                        <div style="display: flex;justify-content: left;align-items: center;gap: 6px;">
                            <el-switch @change="(value: any) => handleUserStatus(scope.row, 'speak', value)"
                                :model-value="scope.row.speakStatus" active-color="#e63f31" inactive-color="#f1f1f1"
                                active-text="禁言" inactive-text="正常">
                            </el-switch>
                            <el-tooltip class="item" effect="dark" content="【禁言状态】用户不可交流；【正常状态】：账户交流权限正常使用"
                                placement="bottom-end">
                                <el-icon style="cursor: pointer;">
                                    <Warning />
                                </el-icon>
                ...
                <el-tab-pane label="基本信息" name="second">
                    <el-form :model="userForm" label-width="80px">
                        ...
                        <el-form-item label="生日">
                            <el-date-picker :value-format="'YYYY-MM-DD'" v-model="userForm.birthday" type="date"
                                placeholder="选择生日" style="width: 100%" />
                        </el-form-item>
                    </el-form>
                </el-tab-pane>
            </el-tabs>

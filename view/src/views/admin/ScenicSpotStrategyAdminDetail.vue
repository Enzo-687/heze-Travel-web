    ...
    <div class="scenic-detail-container">
        ...
        <div v-if="scenicSpotStrategyDetail.id" class="detail-content">
            ...
            <div style="margin-top: 30px;">
                <el-page-header @back="$router.go(-1)" icon="ArrowLeft" content="景点攻略详情"></el-page-header>
            </div>

            <div class="title" style="margin-block: 30px;">
                {{ scenicSpotStrategyDetail.title }}
            </div>

            <div class="base-info">
                <img :src="scenicSpotStrategyDetail.avatar" alt="" srcset="">
                <span>{{ scenicSpotStrategyDetail.username }}</span>
            </div>
            ...
            <div class="info-cards">
                ...
                <div class="summary-card info-card">
                    <p class="summary-text">
                        <span class="text">{{ scenicSpotStrategyDetail.summary }}</span>
                    </p>
                </div>
            </div>
            ...
            <div>
                <Tab :buttons="[
                    { label: '景点介绍', value: 'introduce' },
                    { label: '用户评论', value: 'evaluations' }
                ]" :initialActive="tabIndex" @change="handleChange" />
            </div>

            <!-- 详细内容 -->
            <div class="content-section" v-if="tabIndex === 'introduce'">
                <div class="content-wrapper" v-html="scenicSpotStrategyDetail.content"></div>
            </div>
            <!-- 用户评论 -->
            <div class="content-section" v-if="tabIndex === 'evaluations'">
...
const tabIndex = ref('introduce') // 初始Tab为景点介绍
...
const handleChange = (obj: { value: string }) => {
    tabIndex.value = String(obj.value)
}

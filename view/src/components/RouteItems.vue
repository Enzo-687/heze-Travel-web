                ...
                <div v-for="(route, index) in scenicSpotRouteItemList" :key="`card-${route.id}`" class="fan-card"
                    ...
                    <div class="card-content">
                        ...
                        <div style="display: flex;justify-content: space-between;">
                            <!-- 修改按钮 -->
                            <div class="fun-btn" @click.stop="handleConfirm(route)">修改路线</div>
                            <!-- 删除按钮 -->
                            <div class="cannel" @click.stop="handleDelete(route)">删除</div>
                        </div>
                    </div>
                </div>
            </div>
...
const emit = defineEmits<{
    (e: 'update', route: any): void,
    (e: 'routes', route: any): void,
    (e: 'delete', route: any): void
}>()
...
.meter-bar {
    height: 100%;
    background: linear-gradient(90deg, #42b983, #ff6b6b);
    border-radius: 15px;
